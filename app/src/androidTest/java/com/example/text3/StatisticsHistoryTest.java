...
public class StatisticsHistoryTest {
    ...
    @Test
    public void statisticsHistoryTest() {
        ...
        onView(withId(R.id.appHistoryButton)).perform(scrollTo());

        onView(allOf(withId(R.id.appHistoryButton), isDisplayed())).perform(click());
